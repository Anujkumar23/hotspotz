        ...
        <div className=" flex items-center justify-between flex-col">
          ...
          <div className="w-auto">
            <div className=" flex ">
              ...
              <div className="w-auto p-1.5">
                <a href="https://github.com/Anujkumar23">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full  hover:border-gray-400">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
                      y="0px"
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.linkedin.com/in/anuj-kumar-76509a20b">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full  hover:border-gray-400">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
